 ...
 * La classe VueListeProjetOuvrir représente une vue permettant d'ouvrir un projet.
 * Elle affiche un champ de texte pour entrer l'ID du projet à ouvrir.
 */
package vues;
...
public class VueListeProjetOuvrir extends JPanel {
	...
	public VueListeProjetOuvrir(Utilisateur modeleUtilisateur) {
